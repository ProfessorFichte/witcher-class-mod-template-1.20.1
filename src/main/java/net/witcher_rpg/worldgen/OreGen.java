...
public class OreGen {
    ...
    public static final Identifier NETHER_DARK_IRON_ORE_ID = new Identifier(WitcherClassMod.MOD_ID, "dark_iron_ore_nether_placed");
    public static final Identifier METEORITE_ID = new Identifier(WitcherClassMod.MOD_ID, "dark_iron_ore_placed");
    ...
    public static final RegistryKey<PlacedFeature> NETHER_DARK_IRON_ORE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(WitcherClassMod.MOD_ID, "dark_iron_ore_nether_placed"));
    public static final RegistryKey<PlacedFeature> METEORITE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(WitcherClassMod.MOD_ID, "meteorite"));
