...
public class EffectsConfig {
    public float aerondight_attack_increase_per_stack = 0.050f;
    public float aerondight_spell_crit_chance_increase_per_stack = 0.0250f;
    public float aerondight_spell_crit_damage_increase_per_stack = 0.05f;
    public float yrden_magical_trap_speed_reduction = -0.10f;
    public float axii_damage_increase = 0.10F;
